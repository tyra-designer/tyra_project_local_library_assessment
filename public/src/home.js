function getTotalBooksCount(books) {
  // YOUR SOLUTION HERE
  //will use the same formula as getTotalAccountsCount
  if (books.length === 0) return 0; //this part is correct
...
function getTotalAccountsCount(accounts) {
  // YOUR SOLUTION HERE
  //find the total amount of accounts in the array
  //return 0 if array is empty
  //return total amount of accounts
  if (accounts.length === 0) return 0; //this part is correct
...
function getBooksBorrowedCount(books) {
  // YOUR SOLUTION HERE
  //look through the list of books, find what books have been borrowed, sum up the number of borrowed books
  //refer to data books, borrowed books are non returned books, aka returned must be false
  //after testing: should return the total number of books that are currently borrowed 
